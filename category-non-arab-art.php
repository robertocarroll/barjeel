		...
		<section id="primary" class="site-content">
			<div id="content" class="container" role="main">
				...
				if ( is_tax() ) {
					...
					if ($term->count == 1) {
						echo  '<div class="collection-meta"><h2 class="category-description inline"><span class="red bold uppercase">' .$term->name. '</span> - we have <span class="bold uppercase blue"> ' .$term->count. '</span> artwork by this artist.</h2></div>';
					}

					else {
						echo  '<div class="collection-meta"><h2 class="category-description gray inline"><span class="red bold uppercase">' .$term->name. '</span> - we have <span class="bold uppercase blue"> ' .$term->count. '</span> artworks by this artist.</h2></div>';
					}

					}

					else {
						echo '<div class="collection-meta-non-arab"><h2 class="category-description inline">The non-Arab art collection is a small portion of the personal collection of Sultan Sooud Al Qassemi. We have <span class="bold uppercase blue">' .$total_posts. '</span> artworks in this collection.</h2></div>' ;
					}
